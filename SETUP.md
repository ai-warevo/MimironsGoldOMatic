...
| Guide | Audience |
|--------|----------|
| **[SETUP-for-developer.md](SETUP-for-developer.md)** | Contributors: prerequisites, PostgreSQL, Backend configuration (including Twitch keys), running .NET / npm projects from source. |

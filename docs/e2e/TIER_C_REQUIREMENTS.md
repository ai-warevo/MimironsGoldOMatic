...
| Area | Path / doc |
|------|------------|
| EBS APIs | `src/Backend/MimironsGoldOMatic.Backend.Api/` — Desktop routes, Helix, harness `POST /api/e2e/prepare-pending-payout` (Development only). |
...
| **Integration points** | [`HelixChatService`](../../src/Backend/MimironsGoldOMatic.Backend.Services/HelixChatService.cs), [`TwitchEventSubController`](../../src/Backend/MimironsGoldOMatic.Backend.Api/Controllers/TwitchEventSubController.cs), Extension JWT contract. |
...
|-----------|------|--------------|
| **EBS** | [`src/Backend/MimironsGoldOMatic.Backend.Api/`](../../src/Backend/MimironsGoldOMatic.Backend.Api/) | Optional **Helix** / **EventSub** env-specific config; harness remains **Development-only**. |

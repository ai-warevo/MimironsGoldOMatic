...
- [x] **A1–A3:** Configurable Helix base URL in Backend ([`HelixChatService`](../../src/MimironsGoldOMatic.Backend/MimironsGoldOMatic.Backend.Application/Roulette/Enrollment/HelixChatService.cs), [`TwitchOptions`](../../src/MimironsGoldOMatic.Backend/MimironsGoldOMatic.Backend.Configuration/TwitchOptions.cs), docs/appsettings).

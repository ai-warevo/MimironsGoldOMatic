...
Checklist and follow-ups after **CI Tier B** is enabled in [`.github/workflows/e2e-test.yml`](../../.github/workflows/e2e-test.yml). **Plan / results:** [`docs/e2e/E2E_AUTOMATION_PLAN.md`](E2E_AUTOMATION_PLAN.md) (**[Tier B Integration Results](E2E_AUTOMATION_PLAN.md#tier-b-integration-results)**).

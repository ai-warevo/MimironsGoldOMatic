...
|------|----------------|--------------------|
| **EBS** (Development + E2E harness) | [`src/MimironsGoldOMatic.Backend.Api/`](../../src/MimironsGoldOMatic.Backend.Api/) | **8080** |
...
Source of truth for options: [`TwitchOptions.cs`](../../src/MimironsGoldOMatic.Backend.Abstract/Configuration/TwitchOptions.cs), Backend [`appsettings.Development.json`](../../src/MimironsGoldOMatic.Backend.Api/appsettings.Development.json) (if present), workflow `env` block.
...
| **Change HTTP choreography** | Update **SyntheticDesktop** and [`run_e2e_tier_b.py`](../../.github/scripts/run_e2e_tier_b.py) together; align with [`DesktopPayoutsController`](../../src/MimironsGoldOMatic.Backend.Api/Controllers/DesktopPayoutsController.cs). |

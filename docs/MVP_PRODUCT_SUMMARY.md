...
**Normative source:** [`docs/SPEC.md`](SPEC.md) (APIs, transitions, persistence, log formats). This page is a **consolidated digest** for README-style overviews; it does **not** override the spec.
...
**DDD + CQRS + event sourcing**; **Marten / PostgreSQL** write model; **EF Core** optional read-side only — see [`docs/ARCHITECTURE.md`](ARCHITECTURE.md).

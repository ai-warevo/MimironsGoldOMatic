<!-- This document describes the WPF Desktop UI for MimironsGoldOMatic. For general UI guidelines (colors, typography, design tokens, cross-app navigation), see [Main UI spec](../UI_SPEC.md). -->

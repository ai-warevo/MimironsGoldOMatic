...
- **Update:** `docs/SPEC.md` glossary, §3, §5, §9–11; root README/CONTEXT/AGENTS; component ReadMEs; INTERACTION_SCENARIOS SC-001; UI_SPEC; ROADMAP; IMPLEMENTATION_READINESS.

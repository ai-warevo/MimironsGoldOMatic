...
- **Terminology:** **`MimironsGoldOMatic.Backend`** is the **EBS (Extension Backend Service)**; use in `docs/SPEC.md` for JWT and Helix credential ownership.
...
Apply to `docs/SPEC.md`, `docs/ROADMAP.md`, `CONTEXT.md`, and component ReadMEs:
...
6. **`docs/ROADMAP.md`:** Align **Backend** → **EBS** in prose; keep project name `MimironsGoldOMatic.Backend`.

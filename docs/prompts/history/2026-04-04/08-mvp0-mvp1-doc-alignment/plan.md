...
3. **Docs:** Update `docs/components/shared/ReadME.md`, `docs/overview/ROADMAP.md` (MVP-1 bullets), and `docs/reference/IMPLEMENTATION_READINESS.md` (matrix + parity table) so written contracts match code.

...
3. Extend `docs/E2E_AUTOMATION_PLAN.md` with readiness verification, first run guide, troubleshooting rows.
4. Update Backend ReadME Tier B setup; add `docs/TIER_B_PRELAUNCH_CHECKLIST.md`; refresh `TIER_B_IMPLEMENTATION_TASKS.md` statuses.

...
- Desktop **WinAPI** focus, **`PostMessage`** vs **`SendInput`**, and **`/run`** chunking (&lt;255 characters) must stay aligned with [`docs/SPEC.md`](SPEC.md) §8–10.
- WoW **addon payload** format stays compatible with Desktop chunking (see [`docs/SPEC.md`](SPEC.md) §9).

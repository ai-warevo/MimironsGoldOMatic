...
- **E2E automation**: [Plan](e2e/E2E_AUTOMATION_PLAN.md), [Tasks](e2e/E2E_AUTOMATION_TASKS.md), [Tier B implementation](e2e/TIER_B_IMPLEMENTATION_TASKS.md), [Pre-launch checklist](e2e/TIER_B_PRELAUNCH_CHECKLIST.md), [Post-launch verification](e2e/TIER_B_POSTLAUNCH_VERIFICATION.md), [Tier C requirements (draft)](e2e/TIER_C_REQUIREMENTS.md), [Team announcement template](e2e/TIER_B_TEAM_ANNOUNCEMENT.md)
- **Components**:

...
- **[Twitch Extension UI](../components/twitch-extension/UI_SPEC.md)** — **UI-101–106** (MVP-5 viewer), **UI-201–204** (post-MVP broadcaster reference)
- **[WPF Desktop UI](../components/desktop/UI_SPEC.md)** — **UI-301–308** (MVP-4)
- **[WoW Addon UI](../components/wow-addon/UI_SPEC.md)** — **UI-401–405** (MVP-3)
